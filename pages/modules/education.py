...
def set_data_capture_form(conn,patient_id,st,widgets,components):   
    ...
    if modal.is_open():
        ...
        with modal.container():
            ...
            score = ''
            scale = ''
            reading_date = st.date_input("Reading date",format="YYYY-MM-DD",key="education-date")
            
            mmol = st.number_input("HBA1C %:",key="education-reading")
            if st.button('Submit reading',key="education-submit"):
